...
const PlayStation = () => {
  ...
  return (
    <div className="pagina-principal">
      <Header
        onSearch={setSearch}
        onSearchEnter={(texto) => fetchPlayStationGames(texto)}
      />
      ...
      <main className="contenedor-games">
        {loadingPlayStation ? (
          <p className="cargando">
            {estaBuscando
              ? "Buscando juegos de PlayStation..."
              : "Cargando videojuegos de PlayStation..."}
          </p>
          ...
          <p className="no-resultados">
            {estaBuscando
              ? `No se encontraron juegos de PlayStation para "${search}".`
              : "No hay videojuegos de PlayStation disponibles para este filtro."}
          </p>
        )}
      </main>
